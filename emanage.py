...
root = Tk()
root.title("INFOBELL IT SOLUTION")
...
# Entries Frame
entries_frame = Frame(root, bg="#FA8072")
entries_frame.pack(side=TOP, fill=X)
title = Label(entries_frame, text="INFOBELL IT SOLUTION", font=("YELLOWTAIL", 18, "bold"), bg="#0000FF", fg="gold1")
...
lblEmail = Label(entries_frame, text="Email", font=("Charcoal", 16), bg="#535c68", fg="white")
lblEmail.grid(row=2, column=2, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("Charcoal", 16), width=30)
txtEmail.grid(row=2, column=3, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Gender", font=("Charcoal", 16), bg="#535c68", fg="white")
lblGender.grid(row=3, column=0, padx=10, pady=10, sticky="w")
comboGender = ttk.Combobox(entries_frame, font=("Charcoal", 16), width=28, textvariable=gender, state="readonly")
...
txtContact = Entry(entries_frame, textvariable=contact, font=("Charcoal", 16), width=30)
txtContact.grid(row=3, column=3, padx=10, sticky="w")

lblAddress = Label(entries_frame, text="Address", font=("Charcoal", 16), bg="#535c68", fg="white")
lblAddress.grid(row=4, column=0, padx=10, pady=10, sticky="w")

txtAddress = Text(entries_frame, width=85, height=5, font=("Charcoal", 16))
